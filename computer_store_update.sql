...
INSERT INTO `brands` VALUES (1,'Dell','DELL',1,NULL,'2025-11-23 15:33:39','2025-11-23 15:33:39',NULL,_binary '/web_computer_00_war/uploads/brands/ebd1d36ccf354e2e8ed7b16a67a25f20.png'),(2,'Asus','ASUS',1,NULL,'2025-11-23 15:33:39','2025-11-23 15:33:39',NULL,_binary '/web_computer_00_war/uploads/brands/5f2620de38b445f6ac15cb71a8367d71.png'),(3,'Apple','APPLE',1,NULL,'2025-11-23 15:33:39','2025-11-23 15:33:39',NULL,_binary '/web_computer_00_war/uploads/brands/9528303158604de2a0926bc36001554b.webp'),(4,'HP','HP',1,NULL,'2025-11-23 15:33:39','2025-11-23 15:33:39',NULL,_binary '/web_computer_00_war/uploads/brands/e42d3e2bf1f14f3d8702dd3b27558749.png'),(5,'Logitech','LOGITECH',1,NULL,'2025-11-23 15:33:39','2025-11-23 15:33:39',NULL,_binary '/web_computer_00_war/uploads/brands/58c5fc4f918b45ce8d581187e8994e5a.webp'),(6,'Xiaomi','Xiaomi',1,NULL,'2025-12-07 11:42:58','2025-12-07 11:42:58',NULL,_binary '/web_computer_00_war/uploads/brands/5b65a7566b264f398dc8b097e9c41c1b.webp');
...
INSERT INTO `newsletter_subscriptions` VALUES (3,'xuanloc9a9@gmail.com','active','2025-12-11 04:48:00',NULL);
...
CREATE TABLE `products` (
  ...
  `logo_blob` mediumblob,
  `image` blob,
  `original_price` double DEFAULT NULL COMMENT 'Giá gốc của sản phẩm (trước khi giảm giá)',
  `discount_percentage` double DEFAULT NULL COMMENT 'Phần trăm giảm giá (ví dụ: 20 = 20%)',
  `is_on_sale` tinyint(1) DEFAULT '0' COMMENT 'Có đang giảm giá không (1 = có, 0 = không)',
  `sale_start_date` timestamp NULL DEFAULT NULL COMMENT 'Ngày bắt đầu giảm giá',
  `sale_end_date` timestamp NULL DEFAULT NULL COMMENT 'Ngày kết thúc giảm giá',
  PRIMARY KEY (`id`),
  UNIQUE KEY `slug` (`slug`),
  KEY `category_id` (`category_id`),
  KEY `brand_id` (`brand_id`),
  KEY `idx_is_on_sale` (`is_on_sale`),
  KEY `idx_sale_dates` (`sale_start_date`,`sale_end_date`),
...
INSERT INTO `products` VALUES (1,'Asus ROG Strix G15','asus-rog-strix-g15','<p>Laptop gaming cấu h&igrave;nh khủng, tản nhiệt tốt</p>\r\n\r\n<p><img alt=\"Asus ROG Strix G15 G513IH HN015W | Chính Hãng Giá Rẻ Nhất\" src=\"https://laptop15.vn/wp-content/uploads/2023/04/ASUS-ROG-Strix-G15-G513IE-HN246W-2.png\" /></p>',28000000,20,NULL,5,2,1,'2025-11-23 15:33:39','2025-11-23 15:33:39',NULL,_binary '/web_computer_00_war/uploads/products/01765bc20569450984f7e5ea73f89e13.jpg',28000000,NULL,0,NULL,NULL),(2,'MacBook Air M2 2022','macbook-air-m2-2022','<p>Thiết kế mỏng nhẹ, chip M2 mạnh mẽ</p>\r\n\r\n<p><img alt=\"MacBook Air (M2, 2022) - Thông số kỹ thuật - Bộ phận hỗ trợ của Apple (VN)\" src=\"https://cdsassets.apple.com/live/SZLF0YNV/images/sp/111867_SP869-2022-macbook-air-m2-colors.png\" /></p>',15900000,20,NULL,6,3,1,'2025-11-23 15:33:39','2025-11-23 15:33:39',NULL,_binary '/web_computer_00_war/uploads/products/1068ec2d1e94483aa1665453127f23cd.jpg',26500000,40,1,NULL,NULL),(3,'Dell XPS 13 Plus','dell-xps-13-plus','<p>Laptop doanh nh&acirc;n cao cấp, m&agrave;n h&igrave;nh v&ocirc; cực</p>\r\n\r\n<p><img alt=\"Laptop Dell XPS 13 Plus 9320 i5 (71013325) - Chính hãng, mua trả chậm\" src=\"https://cdn.tgdd.vn/Products/Images/44/314838/dell-xps-13-plus-9320-i5-71013325-1-750x500.jpg\" /></p>',42000000,100,'',7,1,1,'2025-11-23 15:33:39','2025-11-23 15:33:39',NULL,_binary '/web_computer_00_war/uploads/products/1e0d3af45aa140a4ad4adb35e4326519.jpg',42000000,NULL,0,NULL,NULL),(4,'Chuột Logitech G502','chuot-logitech-g502','<p>Chuột gaming cảm biến HERO</p>\r\n\r\n<p>chuột c&oacute; d&acirc;y</p>\r\n\r\n<p><img alt=\"Chuột Logitech G502 Hero Gaming chính hãng, gá rẻ\" src=\"https://cdnv2.tgdd.vn/mwg-static/tgdd/Products/Images/86/326725/chuot-co-day-gaming-logitech-g502-hero-den-1-638622770814523787-750x500.jpg\" /></p>',594000,8,NULL,8,5,1,'2025-11-23 15:33:39','2025-11-23 15:33:39',NULL,_binary '/web_computer_00_war/uploads/products/d24c2f5956f74e5f9d1d7825503f1c2e.png',990000,40,1,'2025-12-10 21:40:00','2025-12-11 21:40:00'),(5,'Xiaomi Redmi Note 14 6GB/128GB','xiaomi-redmi-not-14-64gb','<p><img alt=\"Xiaomi Redmi Note 14 6GB/128GB\" src=\"https://cdnv2.tgdd.vn/mwg-static/tgdd/Products/Images/42/320729/Kit/redmi-note-14-note-638724626243747656.jpg\" /></p>',3220000,10,NULL,10,6,1,'2025-12-07 11:52:45','2025-12-07 11:52:45',NULL,_binary '/web_computer_00_war/uploads/products/29d9572f653c4335a6ce4a9d09e5e869.webp',4600000,30,1,'2025-12-11 00:58:00','2025-12-12 00:58:00'),(6,'hàdhjsk','sadf-sdfsd','',90000,10,NULL,1,2,1,'2025-12-11 07:50:29','2025-12-11 07:50:29',NULL,NULL,100000,10,1,NULL,NULL);
...
INSERT INTO `users` VALUES (1,'admin_system','admin@store.com','12345678','Quản Trị Viên Chính','0909000111','Hà Nội',1,'ADMIN','2025-11-23 15:33:39','2025-11-23 15:33:39',NULL),(2,'staff_sales','staff@store.com','12345678','Nhân Viên Bán Hàng','0909000222','Đà Nẵng',1,'STAFF','2025-11-23 15:33:39','2025-11-23 15:33:39',NULL),(3,'customer_nam','nam.nguyen@gmail.com','12345678','Nguyễn Văn Nam','0912345678','123 Lê Lợi, TP.HCM',0,'CUSTOMER','2025-11-23 15:33:39','2025-11-23 15:33:39',NULL),(4,'customer_huong','huong.tran@gmail.com','12345678','Trần Thị Hương','0987654321','456 Nguyễn Huệ, TP.HCM',0,'CUSTOMER','2025-11-23 15:33:39','2025-11-23 15:33:39',NULL),(5,'dinhythuc240594@gmail.com','dinhythuc240594@gmail.com','12345678','Thức Đinh','0982109103','22 Đường số 6',1,'CUSTOMER','2025-12-06 03:26:41','2025-12-06 03:26:41',NULL),(8,'xuanloc9a9@gmail.com','xuanloc9a9@gmail.com','Xl@110405','Xuân Lộc','0914316842','',1,'CUSTOMER','2025-12-11 04:41:43','2025-12-11 04:41:43',NULL);
...
-- Dump completed on 2025-12-11 17:15:34
