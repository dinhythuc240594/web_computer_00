...
<%
    ...
    String previewImg = category != null && category.getImage() != null && !category.getImage().isEmpty() ? category.getImage():"";
%>
<!doctype html>
...
<head>
    ...
    <title><%= category != null ? "Chỉnh sửa" : "Thêm" %> Danh mục - Staff</title>
                            ...
                            <form method="post" id="updateCategoryForm" action="${contextPath}/category" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" 
                                           value="<%= category != null && category.getName() != null ? category.getName() : "" %>" required/>
                                </div>
                                        ...
                                        <%
                                            if (parentCategories != null) {
                                                for (CategoryDAO parent : parentCategories) {
                                                    if (category == null || parent.getId() != category.getId()) {
                                        %>
                                            <option value="<%= parent.getId() %>" 
                                                    <%= category != null && category.getParent_id() == parent.getId() ? "selected" : "" %>>
                                                <%= parent.getName() %>
                                            </option>
                                        <%
                                                    }
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="is_active" value="true" 
                                                   id="is_active" <%= category.getIs_active() != null && category.getIs_active() ? "checked" : "" %>/>
