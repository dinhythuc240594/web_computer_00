    ...
    <div class="large-container">
        <div class="row clearfix">
            <div class="col-lg-3 col-md-6 col-sm-12 shop-block">
                <div class="shop-block-three alternat-2" style="height: 100%;">
                    <div class="inner-box" style="height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        <span class="text" style="font-size: 22px; font-weight: 700; letter-spacing: 0.5px;">Laptop</span>
                        <figure class="image r_0 b_10 float-bob-y" style="margin: 0; width: 100%; height: 100%; display: flex; align-items: center; justify-content: center;">
                            <img src="${pageContext.request.contextPath}/assets/client/images/background/banner14.webp" alt="Laptop" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px;">
                        </figure>
                    </div>
                </div>
            </div>
            <div class="col-lg-9 col-md-6 col-sm-12 shop-block">
                <style>
                    .laptop-grid .shop-block-two .inner-box {
                        display: flex;
                        flex-direction: column;
                        height: 100%;
                        min-height: 400px;
                    }
                    .laptop-grid .shop-block-two .lower-content {
                        flex: 1;
                        display: flex;
                        flex-direction: column;
                    }
                    .laptop-grid .shop-block-two .image-box figure {
                        height: 220px;
                        overflow: hidden;
                        display: flex;
                        align-items: center;
                    ...
                    .laptop-grid .shop-block-two .image-box img {
                        width: 100%;
                        height: 100%;
                        object-fit: cover;
                    }
                    .laptop-grid .shop-block-two .image-box {
                        position: relative;
                    }
                    .laptop-grid .discount-product,
                    .laptop-grid .new-product {
                        position: absolute;
                        top: 10px;
                        background: #ff4444;
                        color: white;
