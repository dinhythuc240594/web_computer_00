...
<%
    ...
    boolean hasSearchParams = (searchKeyword != null && !searchKeyword.isBlank()) || selectedCategoryId > 0;
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Tìm kiếm sản phẩm - Cửa hàng máy tính HCMUTE</title>
        ...
        <div class="large-container">
            ...
            <%
                ...
                if (productPage != null && productPage.getTotalPage() > 1) {
                    ...
                    // Xây dựng URL base
                    String baseUrl = contextPath + "/shop?";
                    if (searchKeyword != null && !searchKeyword.isBlank()) {
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div style="text-align: center; padding: 60px 20px;">
                        ...
                        <a href="<%= contextPath %>/home" class="theme-btn btn-one">Về trang chủ</a>
                    </div>
                </div>
            </div>
            <%
