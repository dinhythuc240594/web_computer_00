            ...
            <div class="form-inner">
                <form method="post" action="login.html">
                    ...
                    <ul class="social-links clearfix">
                        <li>
                            <a href="login.html"><img src="assets/images/icons/icon-8.png" alt="">Continue with Google</a>
                        </li>
                        <li>
                            <a href="login.html"><img src="assets/images/icons/icon-9.png" alt="">Continue with Facebook</a>
                        </li>
                    </ul>
                </form>
                ...
                <div class="lower-text centred"><p>Not registered yet? <a href="signup.html">Create an Account</a></p></div>
            </div>
        </div>
    </section>
    <!-- sign-section end -->
