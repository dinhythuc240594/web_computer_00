    ...
    <div class="outer-box">
        ...
        <div class="category-box">
            <ul class="category-list clearfix">
                <li class="category-dropdown"><a href="#">Điện thoại & Máy tính bảng</a>
                    <ul>
                ...
                <li class="category-dropdown"><a href="#">Laptop & Máy tính để bàn</a>
                    <ul>
                ...
                <li class="category-dropdown"><a href="#">Thiết bị âm thanh</a>
                    <ul>
                ...
                <li class="category-dropdown"><a href="#">Thiết bị ngoại vi</a>
                    <ul>
                ...
                <li class="category-dropdown"><a href="#">Ốp & Kính cường lực</a>
                    <ul>
                ...
                <li class="category-dropdown"><a href="#">Thiết bị điện tử thông minh</a>
                    <ul>
            ...
            <ul class="category-list clearfix">
                <li><a href="index.html">Sản phẩm mới <span>Mới</span></a></li>
                <li><a href="index.html">Hàng giảm giá</a></li>
                <li><a href="index.html">Sản phẩm bán chạy <span>Gợi ý cho bạn</span></a></li>
            </ul>
        </div>
        <p>HỖ TRỢ</p>
        <ul class="category-list pb_30 clearfix">
            <li><a href="index.html">Yêu thích</a></li>
            <li><a href="index.html">So sánh</a></li>
